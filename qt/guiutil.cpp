...
void setupAddressWidget(QValidatedLineEdit *widget, QWidget *parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a SMTH address (e.g. %1)").arg("CKypUoDqN31ptAQNcQn157RJf5T671QF92"));
#endif
...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("smth://", Qt::CaseInsensitive))
    {
        uri.replace(0, 10, "smth:");
    }
...
{
    QString ret = QString("smth:%1").arg(info.address);
    int paramCount = 0;
